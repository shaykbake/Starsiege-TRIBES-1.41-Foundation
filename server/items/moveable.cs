...
$DoorScale[$ChaingunDamageType] = 0;
$DoorScale[$PlasmaDamageType] = 0.25;
$DoorScale[$TurretDamageType] = 0;
$DoorScale[$DiscDamageType] = 0.25;
$DoorScale[$RocketDamageType] = 1.0;
$DoorScale[$DebrisDamageType] = 1.0;
$DoorScale[$GrenadeDamageType] = 1.0;
$DoorScale[$LaserDamageType] = 0;
$DoorScale[$MortarDamageType] = 1.0;
$DoorScale[$BlasterDamageType] = 0;
$DoorScale[$ELFDamageType] = 0;

...
{
   schedule("message::bottomprint(" @ %cl @ ", \"<f1><jc>Training Mission 8 - Defend and Destroy.\", 5);", 0);
   schedule("message::All(0, \"~wshell_click.wav\");", 0);
   schedule("message::bottomprint(" @ %cl @ ", \"<f1><jc>This is your indoctrination to a Defend and Destroy mission.\", 5);", 5);
   schedule("message::All(0, \"~wshell_click.wav\");", 5);
   schedule("message::bottomprint(" @ %cl @ ", \"<f1><jc>Press O to bring up the Objectives screen for a gameplay description and a list of targets.\", 5);", 10);
...
function Defend::setWayPoint(%cl)
{
   ...
   schedule("message::bottomprint(" @ %cl @ ", \"<jc><f1>Waypoint set to " @ %target.objective @ "\", 5);", %delay);
   schedule("message::All(0, \"~wshell_click.wav\");", %deley);

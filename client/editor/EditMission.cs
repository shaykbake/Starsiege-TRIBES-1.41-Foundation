...
exec( "client/editor/med.cs" );
exec( "client/editor/ted.cs" );
move();
ted();

// add the buttons to the mission editor
addMissionButton( SetGame, "SetPlayingGame.png", "Resume play", "MEModeGame();" );
addMissionButton( SetMission, "SetEditingMission.png", "Mission Edit Mode", "MEModeMission();" );
addMissionButton( SetTerrain, "SetEditingTerrain.png", "Terain Edit mode", "MEModeTed();" );
addMissionButton( Space1 );
addMissionButton( Pause, "SetPauseGame.png", "Pause game", "$SimGame::TimeScale = 0.0;", "$SimGame::TimeScale = 1.0;" );
addMissionButton( Space2 );
addMissionButton( Undo, "Undo.png", "Undo move/rotate", "missionUndoMoveRotate();" );
addMissionButton( Space3 );
addMissionButton( MovementMethod, "Temp.png", "New movement?", "$MED::useOldMovementMethod = false;", "$MED::useOldMovementMethod = true;" );
